 ...
 * @Configuration
 * 
 * @EnableAuthorizationServer public class OAuthConfiguration extends
 ...
 * throws Exception { clients.inMemory()
 * .withClient("fooClientId").secret("secret") .authorizedGrantTypes("password",
