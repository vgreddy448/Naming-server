 ...
 * 
 * @Configuration public class RabbitConfiguration { private static final String
 * LISTENER_METHOD = "receiveMessage";
 * 
 * @Value("${queue.name}") private String queueName;
 * 
 * @Value("${fanout.exchange}") private String fanoutExchange;
 * 
 ...
 * 
 * @Bean MessageListenerAdapter listenerAdapter(QueueConsumer consumer) { return
 * new MessageListenerAdapter(consumer, LISTENER_METHOD); } }
 */
